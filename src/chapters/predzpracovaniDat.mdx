...
<article id="predzpracovaniDat">
    ...
    Přidali jsme do našeho datasetu dva nové sloupce "developer_count" a "publisher_count" - tedy počty her, které byli vyvinuty každým vývojářem a počty her publikované každým vydavatelem.
    ...
    Poté jsme si určili hranice rozdělení:
    - treshold1 = 33.33
    - treshold2 = 66.66

    A také průměrnou hranici hry (avg_game_treshold) na hodnotu 70.

    Vytvořili jsme funkci "assign_group", která nám přiřazuje hodnotu do skupiny na základě hranic a průměrné hodnoty avg_game_treshold. Tuto funkci jsme aplikovali na sloupec hodnocení (rating) a výsledky byly uloženy do nového sloupce "rating_group"
    ...
    Následně jsme "vyfiltrovali" i sloupec, který obsahoval seznam žánrů. Z analýzy jednotlivých četnosti žánrů vyplynulo, že v našem datasetu existuje spoustu žánrů, které mají poměrné malé zastoupení. Pro další zpracování jsme brali v potaz pouze žánry které byly zastoupeny alespoň v počtu 50+ .
    ...
    Odlehlé hodnoty byly z datasetu odstraněny. Práh jsme stanovili na hodnotu 3.
